...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilledMultiColorRounded(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x - 115, 32), ImColor(24, 24, 26), ImColor(6, 249, 249, 50), ImColor(195, 143, 255, 0), ImColor(195, 143, 255, 0), ImColor(195, 143, 255, 50), 4.0f, ImDrawCornerFlags_TopLeft);

    parent_window->DrawList->AddText(Bold, 15.0f, parent_window->DC.CursorPos + ImVec2(16, 9), ImColor(255, 255, 255), name);
